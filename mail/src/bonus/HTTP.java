...
public class HTTP {
    public static void main(String[] args) throws IOException, URISyntaxException, InterruptedException, KeyStoreException, CertificateException, NoSuchAlgorithmException, UnrecoverableKeyException, KeyManagementException, NoSuchProviderException {
        ...
        char[] keyPass = {'p', 'a', 's', 's', 'w', 'o', 'r', 'd'};
        InputStream keyFile = new FileInputStream(new File("./src/clientkeystore"));
        ...
        ServerSocket serverSocket = context.getServerSocketFactory().createServerSocket(8282);
                //SSLServerSocketFactory.getDefault().createServerSocket(8282);
        ...
        try {
            while (true) {
                ...
                PrintWriter startup = new PrintWriter(socket.getOutputStream());
